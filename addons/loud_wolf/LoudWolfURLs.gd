...
var _get_scores_by_player:=api_url+ "get_scores_by_player"
...
func get_scores(maximum:int,ldboard_name:String,period_offset:int) -> String:
...
func get_scores_by_player(player_name: String, maximum: int, ldboard_name: String, period_offset: int) -> String:
	return LoudWolf.URLs._get_scores_by_player+"/" + str(LoudWolf.config.game_id) + "?max=" + str(maximum)  + "&ldboard_name=" + str(ldboard_name.uri_encode()) + "&player_name=" + str(player_name.uri_encode()) + "&period_offset=" + str(period_offset)
